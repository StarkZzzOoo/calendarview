...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
     ...
     * 不可选择的颜色
     */
    protected Paint mDisablePaint = new Paint();
    ...
    private void initPaint(Context context) {
        ...
        mDisablePaint.setTextAlign(Paint.Align.CENTER);
        mDisablePaint.setColor(0xFFe1e1e1);
        mDisablePaint.setFakeBoldText(true);
        mDisablePaint.setTextSize(CalendarUtil.dipToPx(context, TEXT_SIZE));
